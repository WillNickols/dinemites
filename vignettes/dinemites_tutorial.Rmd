...
```{r}
dataset_with_probability_new <- dataset_with_bayesian %>% 
    dplyr::mutate(probability_new = probability_bayesian)
```

```{r, eval = FALSE}
dataset_with_probability_new$probability_new <- NULL
...
manually merging probabilities (e.g., [section 4.2](#merging-probabilities))
...
(e.g., [section 4.2](#merging-probabilities)), this must be
...
```{r, fig.align='center', fig.width=8, fig.height=4, message=FALSE}
